...
@available(*, deprecated, message: "This enum is deprecated. Do not use MindboxLogger.UnknownDecodableError at all.")
public enum UnknownDecodableError: Error {
    case unknownValue
}

@available(*, deprecated, message: "This enum is deprecated. Do not use MindboxLogger.UnknownDecodable at all.")
